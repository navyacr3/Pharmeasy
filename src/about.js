const About = () => {
    return (
        <div className="about" style={{color:'#4f585e',margin:'15px' ,fontSize:'12px'}}>
            <p><b>Top-Selling Healthcare Products:</b>Accu-Chek Active - 100 Strips | Supradyn Multivitamin Tablets | DR Morepen BG 03 - 50 Strips | Dettol Antiseptic Liquid
        | Ensure Diabetes Care Vanilla Sugar Free Jar | Dettol Instant Hand Sanitizer | Everherb Shilajit | Softovac SF Powder | Pediasure Premium Chocolate Refill</p>
        <p><b>Top-Selling Medicines:</b>Dolovera Gel | Neurobion Forte | Chymoral Forte | Crocin Advance | Soframycin| Becadexamin| Dexorange| Folvite| Livogen| Becosules| Fourderm| 
        Nurokind Plus | Burnol | Crocin 650| Mintop 5 | Thrombophob | Evion 600</p>
        <p><b>Top-Searched Healthcare Brands:</b> Accu Chek | Dettol | Horlicks | Protinex | Supradyn | Ensure | Indulekha | Zandu | Pediasure | Dr Morepen</p>
        <p><b>COVID-19 Preventatives:</b></p>
         <p>N95 Masks | Hand Sanitizers | Hand Gloves, Disinfectants, Thermometers & more!</p>
         <p><b>Your One-Stop Online Pharmacy - PharmEasy</b></p>
         <p><b>We've got India Covered!</b></p>
         ...
         <p><b>Say Goodbye to All Your Healthcare Worries With PharmEasy!</b></p>
         ...
         <p><b>How Are We Making Lives Simpler With Our Online Medical Store?</b></p>
        ...
        <p><b>Why Are We The Most Preferred Online Pharmacy?</b></p>
        ...
        <p><b>Sit Back & Relax While You Get Your Essentials Delivered Every Month!</b></p>
        ...
        <p><b>We Believe in ‘Simplifying Healthcare, Impacting Lives!’</b></p>
        </div>
